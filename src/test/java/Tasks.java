...
public class Tasks {
    ...
    @Test
    public void task1() {  // POJO : JSon Object i  (Plain Old Java Object)
        ...
        todo yer =
                given()
                        ...
                        .then()
                        .statusCode(200)
                        .extract().as(todo.class); // Location şablocnu
        ;
     ...
     */
    @Test
    public void task2() {  // POJO : JSon Object i  (Plain Old Java Object)
